...
export default function Registration_Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Trim the input values to remove leading or trailing spaces
        ...
        if (!trimmedName.match(namePattern)) {
            Swal.fire({
                title: 'Error!',
                text: 'Name can only contain letters and not taking blank spaces',
                icon: 'error',
        ...
        if (!trimmedMobile.match(mobilePattern)) {
            Swal.fire({
                title: 'Error!',
        ...
        if (!trimmedName || !trimmedEmail || !trimmedPassword || !trimmedMobile || !trimmedRole) {
            Swal.fire({
                title: 'Error!',
        ...
        try {
            await axios.post('https://demo-clone-1.onrender.com/register', { name: trimmedName, email: trimmedEmail, password: trimmedPassword, mobile: trimmedMobile, role: trimmedRole });
            Swal.fire({
                title: 'Success!',
